            ...
            <div className="flex items-center">
              ...
              <div className="max-sm:w-full   sm:max-md:p-8 flex flex-col max-lgs:items-center gap-5 md:mb-30 mb-20">
                ...
                <p className="text-[clamp(0.8rem,4vw,1.5rem)] text-left leading-7 w-5/6 font-light">
                  ...
                  Proteção ao Crédito, tentou fazer de tudo e mesmo assim o
                  devedor insiste em não querer pagar.
                </p>
              </div>
            </div>
          </section>
        ...
        <ScrollReveal variant="fadeRight" duration={0.4}>
          <section className="bg-[#f4f4f4] flex flex-col gap-7 max-sm:gap-4 sm:pl-18 sm:pr-12 sm:py-12 max-lgs:flex-col  lgs:p-4 max-sm:items-center justify-between">
            <div className="flex gap-35 max-lgs:gap-10 max-sm:flex-col max-lgs:flex-col max-sm:gap-4">
              <div className="flex flex-col gap-7 max-sm:px-6">
                ...
                <p className="text-[clamp(0.8rem,4vw,1rem)] text-left leading-5">
                  ...
                  presenciais com hora marcada, negociações e também
                  formalização dos acordos. Apenas solicitamos uma sala
                ...
                <p className="text-[clamp(0.8rem,4vw,1rem)] text-left leading-5">
                  ...
                  estratégia de cobrança presencial, entrega um retorno de 40%
                  maior que as soluções de negociações digitais ou apenas via
                  call center. Dentro da recuperação de dívida a sua empresa
                  pode optar entre 2 (duas) formas de pagamento de honorários.
                </p>
              </div>
              <img
            ...
            <div className="flex gap-30 max-sm:flex-col max-lgs:flex-col max-sm:gap-4">
              ...
              <div className="flex flex-col gap-7">
                ...
                <p className="text-[clamp(0.8rem,4vw,1rem)] text-left leading-5">
                  ...
                  lembretes e cobranças recorrentes.
                </p>
              </div>
            </div>
          </section>
