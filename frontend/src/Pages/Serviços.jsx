    ...
    <>
      ...
      <main>
        ...
        <section className="bg-[#f4f4f4] flex flex-col gap-7 max-sm:gap-4 sm:pl-18 sm:pr-12 sm:py-12 max-lgs:flex-col p-8 max-sm:items-center justify-between">
          <h2 className="max-lgs:text-center flex max-sm:flex-col md:max-xl:justify-center max-sm:text-left text-start font-family-roboto-slab text-[clamp(1.8rem,4vw,5rem)]/tight font-bold">
            Negociação<span className="text-[#F1B434] sm:ml-2">Presencial</span>
          </h2>
          <div className="flex gap-35 max-lgs:gap-10 max-sm:flex-col max-lgs:flex-col max-sm:gap-4">
            <div className="flex flex-col gap-7">
              <p className="text-[clamp(0.8rem,4vw,1rem)] text-left leading-5">
                Realizamos a cobrança no local que o devedor adquiriu o produto
                ou serviço. Enviamos um de nossos representantes em qualquer
                lugar do Brasil. Este irá realizar atendimentos presenciais com
                hora marcada, negociações e também formalização dos acordos.
                Apenas solicitamos uma sala reservada, impressora e acesso à
                internet.
              </p>
              ...
              <p className="text-[clamp(0.8rem,4vw,1rem)] text-left leading-5">
                ...
                de cobrança presencial, entrega um retorno de 40% maior que as
                soluções de negociações digitais ou apenas via call center.
                Dentro da recuperação de dívida a sua empresa pode optar entre 2
                (duas) formas de pagamento de honorários.
              </p>
            </div>
            <img
        ...
        <section className=" flex flex-col gap-7 sm:p-12 max-lgs:flex-col p-8 max-sm:items-center justify-between">
          <h2 className="max-lgs:text-center flex max-sm:flex-col md:max-xl:justify-center max-sm:text-left text-start font-family-roboto-slab text-[clamp(1.8rem,4vw,5rem)]/tight font-bold">
            Negociação<span className="text-[#F1B434] sm:ml-2">Preventiva</span>
          </h2>
          <div className="flex gap-15 max-sm:flex-col max-lgs:flex-col max-sm:gap-4">
            ...
            <div className="flex flex-col gap-7">
              <p className="text-[clamp(0.8rem,4vw,1rem)] text-left leading-5">
                ...
                redes sociais e boleto impresso) para reduzir até 95% dos
                atrasos recorrentes.
              </p>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="rounded-xl p-6 border border-[#F1B434]/30 shadow-sm transition-all duration-500 ease-in-out hover:scale-105 hover:shadow-lg hover:border-[#F1B434] hover:bg-white cursor-pointer">
                ...
                <p className="text-gray-700 text-sm leading-6">
                  Revisão detalhada de contratos e documentos, identificando as
                  melhores estratégias para recuperação de crédito.
                </p>
              </div>
        ...
        <section className="flex flex-col lg:flex-row min-h-[600px] -z-10">
          <div className="flex-1 bg-white flex flex-col justify-center px-8 py-12 lg:px-16">
            ...
            <div className="flex flex-col gap-6 mb-8">
              ...
              <p className="text-[clamp(0.9rem,2vw,1.1rem)] text-gray-800 leading-7">
                Entendemos que por trás de cada atendimento existe uma história,
                e nosso time está preparado para encontrar a melhor solução para
                ambas as partes.
              </p>
            </div>
