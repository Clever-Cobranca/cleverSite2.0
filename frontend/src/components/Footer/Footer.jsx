    ...
    >
      <div className="flex flex-col justify-around max-md:items-center max-lgs:w-1/3 max-sm:items-stretch">
        <img
          ...
          src={logoFooter}
          className="w-3/5 h-auto max-sm:w-full"
        />
      ...
      <div className="w-1/6 max-sm:text-center max-sm:w-full">
        <nav>
      ...
      <div className="flex flex-col gap-2">
        <div className="max-sm:items-center max-sm:flex max-sm:flex-col">
          <div className="flex items-center gap-3 hover:cursor-pointer transition-all duration-300 ease-in-out">
            ...
            />
            <a href="https://api.whatsapp.com/send/?phone=5508000004820&text=Ol%C3%A1,+Quero+negociar+minhas+dívidas!&type=phone_number&app_absent=0" className="text-orange-primary font-medium text-base max-sm:text-[16px]">
              0800 000 4820
            </a>
          </div>
          <div className="flex items-center md:mt-6 mt-2 gap-3">
            <CiMail
              size={30}
              color="#f1b434"
              className="max-sm:w-[20px] max-sm:h-[20px]"
        ...
        <div className="flex flex-col gap-2 max-sm:items-center max-sm:flex max-sm:flex-col">
          <p className="text-base text-white border-t border-white w-6/12 pt-4">Aprenda conosco:</p>
      ...
      <p className="text-base text-white max-md:block hidden mt-6">
        Copyright © 2025 - Clever Assessoria e Cobrança - CNPJ
        33.331.482/0001-11
      </p>
    </footer>
