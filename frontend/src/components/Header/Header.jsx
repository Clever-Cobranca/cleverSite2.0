...
export function Header({ children }) {
  ...
  return (
    <>
      <header className="pt-4 z-40 flex items-center-safe justify-between max-sm:justify-between pl-16 pr-15 w-full border-b border-t border-black/20 sticky  bg-white">
