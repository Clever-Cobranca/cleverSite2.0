...
export function Header({ children }) {
  ...
  return (
    <>
      <header className="pt-4 z-40 flex items-center-safe justify-between max-sm:justify-between pl-16 pr-15 w-full max-sm:shadow-none max-sm:border-b max-sm:border-t max-sm:border-black/20 shadow-[0_15px_60px_-15px_rgba(0,0,0,0.3)] sticky top-0 bg-white">
