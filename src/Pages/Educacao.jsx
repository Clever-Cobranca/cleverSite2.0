        ...
        <>
            ...
            <main className="mt-25 mb-25">
                <section className="md:flex md:justify-between">
                    <div className="md:w-2/5 md:h-full bg-[#F1B434]">
                        <img className="md:ml-27" src={Alan}/>
                    </div>

                    <div className="md:w-1/2 mt-5 text-center md:text-start">
                        <h1 className="font-family-roboto-slab text-5xl md:text-8xl">Quem é <span className="text-[#707372]">Alan Clever?</span></h1>
                ...
                <section>
                    ...
                    <div className="flex flex-col md:flex-row p-10 md:p-0 justify-center gap-5 md:gap-15">

                        <div className="flex flex-col md:flex-row items-center md:flex md:w-1/3 md:text-center h-4/12 gap-5 justify-around bg-[#E2E2E2] items-center p-3 rounded-4xl">
